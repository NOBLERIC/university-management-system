...
<div class="container text-center">
  <div class="row">
    <div class="col-md-6">
      <form action="studentDataView.jsp" method="post">
    ...
    <div class="col-md-6">
      <form action="ViewEnroll.jsp" method="post">
        <input type="submit" class="btn btn-success" name="target" value="Enrolled Student">
      </form>
    </div>
    <div class="col-md-6">
