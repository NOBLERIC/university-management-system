    ...
    <div class="row">
        ...
        <div class="col-md-10"> <br><br><br>
            ...
            <div class="shadow-lg p-3 bg-white">
                ...
                <center><h3> <b class="text text-info">List Student Per Course   <%= request.getParameter("stdCourses") %> and Semester <%= request.getParameter("selectSemester") %>  </b></h3></center> <br>
