    ...
    <div class="row">
        ...
        <div class="col-md-10"> <br><br><br>
            ...
            <div class="shadow-lg p-3 bg-white">
                ...
                <center><h5> <b class="text text-info">List of Student Per Dept <%= request.getParameter("selectDepartment")%>  and Semester  <%= request.getParameter("selectSemester") %> </b></h5></center> <br>
