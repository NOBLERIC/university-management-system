  ...
  <div class="row">
    ...
    <div class="col-md-10"> <br><br><br>
      ...
      <div class="shadow-lg p-3 bg-white">
        ...
        <center><h5> <b class="text text-info">List Of Course Per Student <%= request.getParameter("selectByName")%> </b></h5></center> <br>
